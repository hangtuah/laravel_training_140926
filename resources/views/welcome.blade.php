    ...
    <header x-data="{ mobileOpen: false, scrolled: false }"
        ...
        <div class="max-w-7xl mx-auto px-6 lg:px-8">
            <div class="flex items-center justify-between h-16">
                ...
                <nav class="hidden md:flex items-center gap-8 text-sm font-medium text-slate-600">
                    ...
                    <a href="#rooms" class="hover:text-blue-700 transition-colors">Rooms</a>
                    <a href="#schedule" class="hover:text-blue-700 transition-colors">Schedule</a>
        ...
        <div x-show="mobileOpen" x-cloak x-transition class="md:hidden border-t border-slate-100 bg-white">
            <div class="px-6 py-4 flex flex-col gap-4 text-sm font-medium text-slate-600">
                <a href="#home" @click="mobileOpen = false" class="hover:text-blue-700">Home</a>
                <a href="#rooms" @click="mobileOpen = false" class="hover:text-blue-700">Rooms</a>
                <a href="#schedule" @click="mobileOpen = false" class="hover:text-blue-700">Schedule</a>
                <a href="#how-it-works" @click="mobileOpen = false" class="hover:text-blue-700">How It Works</a>
                <a href="#availability" @click="mobileOpen = false"
        ...
        <div class="max-w-7xl mx-auto px-6 lg:px-8 py-12">
            <div class="flex flex-col sm:flex-row items-center justify-between gap-6">
                ...
                <nav class="flex items-center gap-6 text-sm text-slate-500">
                    <a href="#rooms" class="hover:text-blue-700 transition-colors">Rooms</a>
                    <a href="#schedule" class="hover:text-blue-700 transition-colors">Schedule</a>
                    <a href="#" class="hover:text-blue-700 transition-colors">Booking Guide</a>
                </nav>
            </div>
